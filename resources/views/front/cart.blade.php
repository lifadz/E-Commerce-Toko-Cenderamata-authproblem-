...
<section class=" section-9 pt-4">
                            ...
                            <tr>
                                <td class="text-start">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <img src="{{asset('upload/produk/gambar_small/'.$item->options->productImage->image)}}" >
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body d-flex justify-content-center align-items-center">
                        <h4>Keranjangmu Kosong ! <!DOCTYPE html>
                        <html lang="en">
                        <head>
                            <meta charset="UTF-8">
    ...
    <script>
        ...
        function showAlert(title, message, icon, button) {
            Swal.fire({
                title: title,
                text: message,
                icon: icon,
    ...
    <script>
        ...
        function deleteItem(rowId){
            ...
            success: function(response) {
                if (response.status) {
                    showAlert('Success', response.message, 'success', 'OK');
                    setTimeout(function () {
                        window.location.href = "{{ route('front.cart') }}";
                    }, 2000);
                    // Refresh halaman atau lakukan manipulasi DOM lainnya jika diperlukan
                } else {
                    showAlert('Error', response.message, 'error', 'OK');
                }
            }
            });
        }
