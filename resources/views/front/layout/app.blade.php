...
<head>
    ...
    <title>E-Commerce Toko Cenderamata Fajri Craft</title>
    ...
    <link rel="icon" href="{{asset('front-assets/images/logofajrii.png')}}">
            ...
            <div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
                <div class="col-lg-4 logo">
                    <a href="{{route('front.home')}}" class="text-decoration-none">
                        <span class="h1 text-uppercase text-primary bg-dark px-2">Fajri</span>
                        <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Craft</span>
                    </a>
                </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-xl" id="navbar">
                <a href="index.php" class="text-decoration-none mobile-logo">
                    <span class="h2 text-uppercase text-primary bg-dark">Fajri</span>
                    <span class="h2 text-uppercase text-white px-2">Craft</span>
                </a>
