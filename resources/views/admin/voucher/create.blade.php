                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" id="code" class="form-control" placeholder="Kode Voucher">
                                <p></p>	
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"  name="name" id="name" class="form-control" placeholder="Nama Voucher">
                                <p></p>	
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"  name="max_uses" id="max_uses" class="form-control" placeholder="Maksimal Pemakaian">
                                <p></p>	
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number"  name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Jumlah Maksimal Pengguna">
                                <p></p>	
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="type" id="type" class="form-control">
                                    <option value="percent">Persentasi</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number"  name="discount_amount" id="discount_amount" class="form-control" placeholder="Besaran Diskon">
                                <p></p>	
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number"  name="min_amount" id="min_amount" class="form-control" placeholder="Besaran Minimal">
                                <p></p>	
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" autocomplete="off"  name="starts_at" id="starts_at" class="form-control" placeholder="Tanggal Awal">
                                <p></p>	
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" autocomplete="off"  name="expires_at" id="expires_at" class="form-control" placeholder="Tanggal Akhir">
                                <p></p>	
                            </div>
                        </div>
                        <div class="col-md-6">
